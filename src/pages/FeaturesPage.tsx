            ...
            <div className="mt-6 overflow-x-auto">
              <table className="w-full border-collapse">
                ...
                <tbody className="text-sm">
                  ...
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Customer library (CRUD + CSV import)</td><td className={yesUs}>Yes</td><td className={no}>No</td><td className={no}>No</td><td className={no}>No</td><td className={no}>—</td></tr>
                  ...
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Printable PDF quotes (auto-numbered, valid-until date)</td><td className={yesUs}>Yes</td><td className={no}>No</td><td className={no}>Limited (PDF export, no auto-#)</td><td className={no}>No</td><td className={no}>Limited (quotes)</td></tr>
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Quote &rarr; Sale conversion (with status tracking)</td><td className={yesUs}>Yes</td><td className={no}>No</td><td className={no}>No</td><td className={no}>No</td><td className={no}>—</td></tr>
