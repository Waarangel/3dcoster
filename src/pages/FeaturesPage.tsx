...
const TOOLS: Tool[] = [
  ...
  { name: '3DPrintForce', price: 'Free + $12.50-39/mo', cover: ['partial', 'none', 'partial', 'partial'] },
];
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr>
                    ...
                    <th className="py-4 px-4 text-center align-bottom"><div className="text-[var(--ink-soft)] font-medium">3DPrintForce</div><div className="text-[var(--ink-faint)] text-sm">Free + $12.50-39/mo</div></th>
                  </tr>
                </thead>
                <tbody className="text-sm">
                  ...
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Multi-filament cost (per-filament weight + price)</td><td className={yesUs}>Yes</td><td className={no}>No</td><td className={no}>Limited</td><td className={yes}>Yes (Pro)</td><td className={yes}>Yes <span className="text-xs text-[var(--ink-faint)]">(paid)</span></td></tr>
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Slicer file import (G-code / 3MF, multi-slicer)</td><td className={yesUs}>Yes (G-code &amp; 3MF)</td><td className={no}>Limited</td><td className={yes}>Yes (G-code)</td><td className={yes}>Yes (G-code)</td><td className={no}>No</td></tr>
                  ...
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Printer depreciation</td><td className={yesUs}>Yes</td><td className={no}>No</td><td className={yes}>Yes</td><td className={yes}>Yes</td><td className={no}>Limited</td></tr>
                  ...
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Customer library (CRUD + CSV import)</td><td className={yesUs}>Yes</td><td className={no}>No</td><td className={no}>No</td><td className={no}>No</td><td className={no}>Limited</td></tr>
                  ...
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Marketplace fees (Etsy / eBay / Amazon Handmade)</td><td className={yesUs}>Yes</td><td className={no}>No</td><td className={no}>Limited (Etsy)</td><td className={yes}>Yes (Etsy/eBay/Amazon)</td><td className={yes}>Yes</td></tr>
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Live Etsy order sync (90-day API import)</td><td className={noUs}>No</td><td className={no}>No</td><td className={no}>No</td><td className={yes}>Yes (£5/mo)</td><td className={yes}>Yes <span className="text-xs text-[var(--ink-faint)]">(paid)</span></td></tr>
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Shipping management (8 carriers + local delivery)</td><td className={yesUs}>Yes</td><td className={no}>No</td><td className={no}>Limited (cost field only)</td><td className={no}>Limited (cost field only)</td><td className={no}>Limited (cost field only)</td></tr>
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Tax / VAT (region default + per-job override)</td><td className={yesUs}>Yes</td><td className={no}>No</td><td className={no}>No</td><td className={yes}>Yes (Pro)</td><td className={no}>—</td></tr>
                  ...
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Printable PDF quotes (auto-numbered, valid-until date)</td><td className={yesUs}>Yes</td><td className={no}>No</td><td className={no}>Limited (PDF export, no auto-#)</td><td className={no}>No</td><td className={no}>No</td></tr>
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Quote &rarr; Sale conversion (with status tracking)</td><td className={yesUs}>Yes</td><td className={no}>No</td><td className={no}>No</td><td className={no}>No</td><td className={no}>No</td></tr>
                  ...
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Filament library management</td><td className={yesUs}>Yes</td><td className={no}>No</td><td className={no}>No</td><td className={yes}>Yes (Pro)</td><td className={yes}>Yes <span className="text-xs text-[var(--ink-faint)]">(paid)</span></td></tr>
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">Works offline (PWA + IndexedDB)</td><td className={yesUs}>Yes</td><td className={no}>Web only</td><td className={yes}>Yes (local parsing)</td><td className={no}>Web only</td><td className={no}>Web only</td></tr>
                  ...
                  <tr className="border-b border-[var(--hairline)]"><td className="py-4 px-4 text-[var(--ink-soft)]">No account required</td><td className={yesUs}>Yes</td><td className={yes}>Yes</td><td className={yes}>Yes</td><td className={no}>Free: yes / Paid: no</td><td className={no}>Calc: yes / Paid: no</td></tr>
                  <tr><td className="py-4 px-4 text-[var(--ink-soft)] font-medium">Price</td><td className="py-4 px-4 text-center text-[var(--brand-soft)] font-bold bg-[rgba(23,150,255,0.13)] border-x border-b rounded-b-xl border-[rgba(23,150,255,0.3)]">Free</td><td className="py-4 px-4 text-center text-[var(--ink-soft)]">Free</td><td className="py-4 px-4 text-center text-[var(--ink-soft)]">Free</td><td className="py-4 px-4 text-center text-[var(--ink-soft)]">Free / £5 / £9 mo</td><td className="py-4 px-4 text-center text-[var(--ink-soft)]">Free calc / $12.50-39 mo</td></tr>
                </tbody>
              </table>
