...
export function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
      ...
      {/* App Preview */}
      <section className="py-16 px-6" aria-label="App preview screenshots">
      ...
      <section className="py-20 px-6" aria-labelledby="features-heading">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 id="features-heading" className="text-3xl font-bold text-white mb-4">Everything You Need to Price Profitably</h2>
      ...
      <section className="py-20 px-6" aria-labelledby="cta-heading">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-2xl p-12 border border-blue-500/20">
            <h2 id="cta-heading" className="text-3xl font-bold text-white mb-4">Ready to Price Smarter?</h2>
      ...
      {/* Support Section */}
      <section className="py-16 px-6" aria-labelledby="support-heading">
        <div className="max-w-3xl mx-auto">
          <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-2xl p-8 md:p-10 border border-yellow-500/20 text-center">
            ...
            <h2 id="support-heading" className="text-2xl md:text-3xl font-bold text-white mb-3">Love 3DCoster?</h2>
